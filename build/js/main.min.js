...
/* harmony import */ var _modules_switch_screens__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/switch-screens */ "./js/modules/switch-screens.js");
...
Object(_modules_switch_screens__WEBPACK_IMPORTED_MODULE_4__["switchScreens"])();
...
var mainScreen = document.querySelector('.main-page');
var header = document.querySelector('.header');
var desktopBreakpoint = '(min-width: ' + 1024 + 'px';
...
var initLoader = function initLoader() {
  ...
  var restartHeaderAnimation = function restartHeaderAnimation() {
    header.classList.remove('header--start-animation');
    void mainScreen.offsetWidth;
    header.classList.add('header--start-animation');
  };

  var restartMainScreenAnimation = function restartMainScreenAnimation() {
  ...
  var onLoaderTouch = function onLoaderTouch(evt) {
    evt.preventDefault();
    loader.classList.remove('loader--show');
...
/***/ "./js/modules/switch-screens.js":
/*!**************************************!*\
  !*** ./js/modules/switch-screens.js ***!
  \**************************************/
/*! exports provided: switchScreens */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var mainScreen = document.querySelector('.main-page');
var content = mainScreen.querySelector('.main-page__content');
var tabletBreakpoint = '(max-width: ' + 1023 + 'px';

var switchScreens = function switchScreens() {
  if (!mainScreen) {
    return;
  }
  ...
  var onMainScreenTouch = function onMainScreenTouch(evt) {
    evt.preventDefault();
